...
const navigation = [
    ...
    {name: "Dialer", href: "#", icon: PhoneIcon, current: true},
    {name: "My Contacts", href: "#", icon: IdentificationIcon, current: false},
    {name: "Analytics", href: "#", icon: ChartPieIcon, current: false},
    {name: "Portal", href: "#", icon: ChartBarSquareIcon, current: false},
    {name: "Team", href: "#", icon: UserGroupIcon, current: false},
    {name: "Support", href: "#", icon: ChatBubbleBottomCenterIcon, current: false},
];
const teams = [
